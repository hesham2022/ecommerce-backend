...
export class CreateChatTables1777350000000 implements MigrationInterface {
  name = 'CreateChatTables1777350000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // admin_audit_log table is created by Phase 6 reviews migration (1777345000000)
  }
